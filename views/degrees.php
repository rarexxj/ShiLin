    ...
    <?php include_once VIEWS.'inc/header.php'; ?>
    	<div class="serwrap por">
    		<div class="service w92 f-cb">
    			<a class="fl" href="<?php echo site_url('degrees'); ?>">APSL型601便携式全自动压力校验台</a>
    			<div class="selsan fr"></div>
    		</div>
			 <div class="selnav">
                <a class="on" href="<?php echo site_url('degrees'); ?>">
                    APSL型601便携式全自动压力校验台  
                </a>
                ...
                <a href="<?php echo site_url('degrees'); ?>">APSL型311系列精密压力校验仪</a>
                <a href="<?php echo site_url('degrees'); ?>">APSL型312系列精密数字压力表</a>
            </div>
    	</div>
